...
<html lang="en">
  ...
  <head>
    ...
    <title>Cheno Smart Resources - AboutS</title>
    ...
    <div class="page-heading header-text">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1>About Us</h1>
            <span>We have over 10 years of experience in helping client set up their wealth portfolio</span>
          </div>
        </div>
      </div>
    </div>
              ...
              <div class="row">
                <div class="col-md-6 align-self-center">
                  <div class="right-content">
                    ...
                    <p>We specialise in helping client build their wealth portfolio like investing, insurance and Will & Trust 
                    <br><br>We focus on not selling just for selling, but rather help customer to customise their needs accordingly.</p>
                  </div>
                </div>
                <div class="col-md-6">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="section-heading">
              ...
              <span>Key person in Cheno Smart Resources</span>
            </div>
          </div>
          <div class="col-md-4">
            <div class="team-item">
            <img src="{{asset('images/team_1.jpg')}}" alt="">
              <div class="down-content">
                <h4>Elohn Go</h4>
                <span>Founder</span>
                <p>10 years of experience in the industry,<br>achieving more than 100 awards in the industry.</p>
              </div>
            </div>
          </div>
          <div class="col-md-4">
            <div class="team-item">
              ...
              <div class="down-content">
                ...
                <p>5 years of experience,<br>MDRT awardee for years 2020, 2021,<br>A4CC members for 48times</p>
              </div>
            </div>
          </div>
          </div>
